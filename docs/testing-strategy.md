...
这份文档定义 v2 的测试驱动开发方式和测试套件组织方式。测试理念、覆盖原则和方法论见 [testing-philosophy.md](./testing-philosophy.md)，按架构模块逐层收敛的计划见 [architecture-test-plan.md](./architecture-test-plan.md)，具体用例目录见 [testing-case-catalog.md](./testing-case-catalog.md)。
